...
namespace FichaOnline.Models
{
    public class TBUnidadeTipos
    {
        ...
        public TBUnidadeTipos(int unidadeTpoId, string unidadeTpoDsc, string unidadeSgl, string unidadeTipo, int unidadeTpoIncPor, DateTime unidadeTpoIncEm, int? unidadeTpoAltPor, DateTime? unidadeTpoAltEm, List<TBUnidades> unidade) : this()
        {
