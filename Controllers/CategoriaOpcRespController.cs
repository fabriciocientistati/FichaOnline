...
{
    public class CategoriaOpcRespController : Controller
    {
        private readonly ContextoDb _context;

        public CategoriaOpcRespController(ContextoDb context)
        {
            _context = context;
        }

        // GET: CategoriaOpcResp
        ...
        // GET: CategoriaOpcResp/Details/5
        ...
        // GET: CategoriaOpcResp/Create
        public IActionResult Create()
        {
            ViewData["CatOpcId"] = new SelectList(_context.TBCATEGORIAOPCOES, "CatOpcId", "CatOpcDesc");
            return View();
        }

        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Create([Bind("FichaCatOpcRespId,CatOpcId,FichaId,FichaCatOpcResIncPor,FichaCatOpcIncEm,FichaCatOpcRespAltPor,FichaCatOpcRespAltEm,CatOpcRespSelecionada")] TBFichaCategoriaOpcResp tBFichaCategoriaOpcResp)
        {
        ...
        // POST: CategoriaOpcResp/Edit/5

        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("FichaCatOpcRespId,CatOpcId,FichaId,FichaCatOpcResIncPor,FichaCatOpcIncEm,FichaCatOpcRespAltPor,FichaCatOpcRespAltEm,CatOpcRespSelecionada")] TBFichaCategoriaOpcResp tBFichaCategoriaOpcResp)
        {
        ...
        // POST: CategoriaOpcResp/Delete/5
