...
namespace FichaOnline.Controllers
{
    public class PerfilController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PerfilAcessoId,PerfilAcessoDesc,PerfilAcessoNivel,PerfilAcessoIncPor,PerfilAcessoIncEm,PerfilAcessoAltPor,PerfilAcessoAltEm")] TBPerfilacesso tbperfilacesso)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PerfilAcessoId,PerfilAcessoDesc,PerfilAcessoNivel,PerfilAcessoIncPor,PerfilAcessoIncEm,PerfilAcessoAltPor,PerfilAcessoAltEm")] TBPerfilacesso tbperfilacesso)
        {
