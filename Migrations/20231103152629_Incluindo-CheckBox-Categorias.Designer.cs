...
namespace FichaOnline.Migrations
{
    ...
    [Migration("20231103152629_Incluindo-CheckBox-Categorias")]
    partial class IncluindoCheckBoxCategorias
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FichaOnline.Models.TBCategoriaOpcoes", b =>
                {
                    ...
                    b.Property<int?>("TBFichaCategoriaOpcRespFichaCatOpcRespId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("TBFichaCategoriaOpcRespFichaCatOpcRespId");
            ...
            modelBuilder.Entity("FichaOnline.Models.TBFichaProvidenciasResp", b =>
                {
                    ...
                    b.Property<int?>("FichaProvFichaFichaId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("FichaProvFichaFichaId");
            ...
            modelBuilder.Entity("FichaOnline.Models.TBCategoriaOpcoes", b =>
                {
                    ...
                    b.HasOne("FichaOnline.Models.TBFichaCategoriaOpcResp", null)
                        .WithMany("CatOpcRespCatOpc")
                        .HasForeignKey("TBFichaCategoriaOpcRespFichaCatOpcRespId");
            ...
            modelBuilder.Entity("FichaOnline.Models.TBFichaProvidenciasResp", b =>
                {
                    b.HasOne("FichaOnline.Models.TBFicha", "FichaProvFicha")
                        ...
                        .HasForeignKey("FichaProvFichaFichaId");
